    ...
    <main className="flex-col flex min-h-screen bg-[#07080C] text-[#F8FAFC]">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden border-b border-amber-500/10">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-[#CBD5E1] text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-[#07080C]/80 text-[#F8FAFC] relative z-10 border-t border-amber-500/10">
        <div className="max-w-[1000px] mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            ...
            {/* Pill 1 */}
            <div className="flex items-center gap-3 p-4 rounded-xl border border-amber-500/20 bg-[#0B0D14] text-[#CBD5E1] shadow-sm">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6 text-xs text-[#CBD5E1] font-semibold">
      ...
      <section className="py-24 relative z-10 border-t border-amber-500/10 bg-[#0B0D14] text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-[#CBD5E1] text-lg md:text-xl font-medium mb-10 max-w-2xl mx-auto">
