...
export const metadata: Metadata = {
  title: "Privacy Policy | area69iptv",
  description: "Learn how area69iptv collects, uses, and protects personal information.",
  alternates: {
    ...
    <main className="flex-grow px-5 pb-20 pt-12 sm:px-8 md:pt-16 text-format-legal">
      <article className="mx-auto max-w-4xl">
        ...
        <div className="mt-10 space-y-10 text-base leading-7 text-on-surface-variant">
          <p>Welcome to area69iptv. We are committed to protecting your personal information and respecting your privacy. If you have questions or concerns about this policy or our data practices, please <Link className="font-semibold text-[#36a9ff] hover:text-[#36a9ff]" href="/contact">contact our support team</Link>.</p>
