        ...
        <div className="strimo-card p-8 lg:p-12 rounded-3xl relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="max-w-2xl text-left">
            ...
            <h3 className="text-3xl lg:text-4xl font-black text-[#F8FAFC] tracking-tight">
              Need Help with <span className="text-cyan-400">area69iptv Setup</span> or Technical Diagnostics?
            </h3>

            <p className="text-[#A7B0C0] text-base mt-3 leading-relaxed">
              Our expert technical support team is available 24/7 on WhatsApp to assist with playlist installation, app configuration, device synchronization, and area69iptv channel troubleshooting.
            </p>
          ...
          <div className="shrink-0">
            <a
              href="https://wa.me/447882781998?text=Hello,%20I%20need%20technical%20assistance%20with%20area69iptv."
              target="_blank"
              rel="noreferrer"
