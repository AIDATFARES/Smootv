      ...
      <div className="relative">
        <div className="mx-auto max-w-3xl px-5 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-gray-600 animate-fade-up" style={{ animationDelay: '0.1s' }}>
            Read real reviews from our global community. Discover why area69iptv is rated as the most reliable, buffer-free IPTV service for live sports, movies, and international channels.
          </p>
        </div>
          ...
          >
            {[...reviewImages, ...reviewImages, ...reviewImages].map((img, index) => (
              ...
              >
                <Image
                  src={`/reviews/${img}`}
                  alt="area69iptv Customer Review"
                  fill
        ...
        <div className="mt-12 text-center animate-fade-up" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
          <a
            href="https://wa.me/447882781998?text=Hello%2C%20I%20would%20like%20a%20free%20trial%20for%20area69iptv."
            target="_blank"
            rel="noreferrer"
