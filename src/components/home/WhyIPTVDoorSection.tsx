...
const primaryFeatures = [
  { icon: Monitor, title: "4K Ultra HD Streaming", text: "Enjoy your area69iptv subscription with crisp 4K, Full HD, and HD quality streams. Our advanced anti-freeze technology ensures seamless playback on every device.", tags: ["4K UHD", "FULL HD", "ANTI-FREEZE"], accent: "violet" },
...
const benefits = [
  { icon: Bolt, title: "Instant Activation", text: "Your area69iptv account activates instantly.", color: "text-[#36a9ff]" },
  { icon: Smartphone, title: "All Devices Supported", text: "Stream IPTV on Smart TVs, Firestick, iOS, and Android.", color: "text-sky-400" },
  { icon: Globe2, title: "Works Worldwide", text: "Take your area69iptv service anywhere in the world.", color: "text-[#36a9ff]" },
  ...
  return <section className="relative overflow-hidden bg-transparent py-24 sm:py-28">
    ...
    <div className="relative mx-auto max-w-[1120px] px-5 sm:px-8">
      <div className="mx-auto mb-14 max-w-3xl text-center">
        ...
        <h2 className="mt-6 text-4xl font-black leading-[0.98] tracking-tight text-black sm:text-5xl"><span className="block">Everything You Need for the</span><span className="mt-1 block text-[#36a9ff]">Ultimate area69iptv Experience.</span></h2>
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-6 text-gray-600">area69iptv delivers premium live television, thrilling sports events, and on-demand entertainment seamlessly-on any supported device, anywhere.</p>
      </div>
